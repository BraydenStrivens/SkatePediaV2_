...
struct AddTrickItemView: View {
    ...
    /// Displays upload progress with a progress bar and cancel option.
    ///
    /// Allows the user to cancel the upload unless it is near completion.
    ///
    /// - Important: Cancellation is disabled after 80% progress to avoid partial uploads.
    ...
    /// Button that initiates the trick item upload.
