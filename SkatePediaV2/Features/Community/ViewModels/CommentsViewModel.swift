...
//            let (initialBatch, lastDocument) = try await commentService.fetchBaseComments(
//                for: postId,
//                batchSize: batchSize,
//                lastDocument: lastBaseCommentDocument
//            )
//            commentStore.addBaseCommentBatch(initialBatch)
//            
//            if let lastDocument { lastBaseCommentDocument = lastDocument}
    ...
    func fetchMoreBaseComments(postId: String) async {
        ...
        do {
//            let (currentBatch, lastDocument) = try await commentService.fetchBaseComments(
//                for: postId,
//                batchSize: batchSize,
//                lastDocument: lastBaseCommentDocument
//            )
...
//            let (currentBatch, lastDocument) = try await commentService.fetchBaseCommentReplies(
//                for: postId,
//                from: baseCommentId,
//                batchSize: batchSize,
//                lastDocument: lastDocumentById[baseCommentId] ?? nil
...
//            
//            if let lastDocument { lastDocumentById[baseCommentId] = lastDocument }
//            replyUIStatesById[baseCommentId]?.hasMore = currentBatch.count == batchSize
//            replyUIStatesById[baseCommentId]?.hasFetched = true
