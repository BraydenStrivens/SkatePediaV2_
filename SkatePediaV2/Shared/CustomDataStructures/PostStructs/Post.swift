...
struct Post: Codable, Identifiable, Hashable {
    ...
    func asPayload() -> [String : Any] {
        return [
            ...
            Post.CodingKeys.showTrickItemRating.rawValue: showTrickItemRating,
            TrickItemData.CodingKeys.trickItemId.rawValue: trickItemData.trickItemId,
        ]
    }
