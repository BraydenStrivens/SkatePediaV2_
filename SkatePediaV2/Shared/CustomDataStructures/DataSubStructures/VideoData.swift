...
struct VideoData: Codable, Hashable {
    ...
    func asPayload() -> [String : Any] {
        if let storagePath {
            return [
                CodingKeys.videoUrl.rawValue: videoUrl,
                CodingKeys.storagePath.rawValue: storagePath,
                CodingKeys.width.rawValue: width,
                CodingKeys.height.rawValue: height
            ]
        } else {
            return [
                CodingKeys.videoUrl.rawValue: videoUrl,
    ...
    func encode(to encoder: any Encoder) throws {
        ...
        try container.encodeIfPresent(self.storagePath, forKey: .storagePath)
