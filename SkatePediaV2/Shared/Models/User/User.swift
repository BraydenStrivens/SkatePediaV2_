...
struct User: Codable, Identifiable, Hashable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case favoriteTricks = "favorite_tricks"
    ...
    init(from decoder: any Decoder) throws {
        ...
        self.favoriteTricks = try container.decodeIfPresent([String].self, forKey: .favoriteTricks)
    ...
    func encode(to encoder: any Encoder) throws {
        ...
        try container.encodeIfPresent(self.favoriteTricks, forKey: .favoriteTricks)
