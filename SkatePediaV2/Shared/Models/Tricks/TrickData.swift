...
struct TrickData: Codable, Hashable, Identifiable {
    ...
    func displayName(_ useAbbreviation: Bool?) -> String {
        (useAbbreviation == true) ? self.abbreviatedName : self.name
    }
    ...
    func asPayload() -> [String : Any] {
        if let stance {
            return [
                CodingKeys.trickId.rawValue: trickId,
                CodingKeys.name.rawValue: name,
                CodingKeys.abbreviatedName.rawValue: abbreviatedName,
