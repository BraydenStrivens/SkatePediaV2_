...
struct TrickItemData: Codable, Identifiable, Hashable {
    ...
    func asPayload() -> [String : Any] {
        return [
            TrickItemData.CodingKeys.trickItemId.rawValue: trickItemId,
            TrickItemData.CodingKeys.progress.rawValue: progress,
            TrickItemData.CodingKeys.notes.rawValue: notes
        ]
    }
